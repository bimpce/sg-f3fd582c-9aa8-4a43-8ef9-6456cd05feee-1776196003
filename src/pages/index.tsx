...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background pb-32 pt-10 px-4 transition-colors duration-300">
        <div className="max-w-md mx-auto space-y-8">
          ...
          <Card className="p-6 rounded-[2rem] border-transparent bg-background neu-flat">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded-full bg-primary flex items-center justify-center text-primary-foreground text-2xl font-bold border-[3px] border-background neu-flat">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <Badge variant="secondary" className="bg-primary/10 text-primary hover:bg-primary/20 font-semibold px-3 py-0.5 rounded-full text-xs uppercase tracking-wider">
          ...
          <Card className="p-4 rounded-[1.5rem] border-transparent bg-background neu-flat overflow-hidden">
            <Calendar
              mode="single"
              ...
              classNames={{
                ...
                day: cn(
                  "h-10 w-10 p-0 font-bold aria-selected:opacity-100 rounded-xl mx-auto flex items-center justify-center hover:bg-primary/10 text-foreground transition-all"
                ),
            ...
            {(() => {
              ...
              return (
                <div className="space-y-3">
                  ...
                  {selectedHoliday && (
                    <Card className="p-6 rounded-[1.5rem] bg-background neu-flat border-transparent shadow-none flex items-center justify-between">
                      <div>
